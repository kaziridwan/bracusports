...
$res=mysqli_query($con, "select * from customer where Email='".$_SESSION['myusername']."'");
...
$res2=mysqli_query($con,"select Tid from pays where Cid = '$custid'");
$ans2=mysqli_fetch_array($res2);
$tid=$ans2[0];
//$tid = $ans['Tid'];
$res1=mysqli_query($con,"select Description from membership where Tid = '$tid'");
